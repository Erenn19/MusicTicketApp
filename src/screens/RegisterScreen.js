...
const RegisterHome = ({ navigation }) => {
    ...
    async function signUp() {
        ...
        try {
            var response = await createUserWithEmailAndPassword(FIREBASE_AUTH, value.email, value.password);
        ...
        <View>
            ...
            <View style={{ width: '100%', height: '60%', backgroundColor: 'white', borderTopLeftRadius: 100 }}>
                <View style={{ width: '100%' }}>
                    ...
                    <TouchableOpacity onPress={() => signUp()} style={{ backgroundColor: 'orange', height: 40, justifyContent: 'center', width: '57%', marginLeft: '20%', marginTop: '10%', borderRadius: 10 }}>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('Login')}>
                        <Text style={{ color: 'orange', marginTop: '-5%', marginLeft: '65%', fontWeight: 'bold', fontSize: 15 }}>Sign In</Text>
                    </TouchableOpacity>
